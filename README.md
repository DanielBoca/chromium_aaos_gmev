...
This is a comprehensive guide on compiling Chromium for any Android Automotive vehicle, but has been tested on the GMC Sierra EV 2024. This process allows you to install the app using the Internal Tester Function on the Google Play Console.

**Disclaimer:** This guide is provided purely for educational purposes. The author and contributors are not responsible for any damage, data loss, legal issues, or other consequences that may result from attempting to follow these instructions. Use this information at your own risk.
...
- Distraction optimized setting for testing
